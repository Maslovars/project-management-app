  ...
  return (
    <EntryPageWrap>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <TextInput htmlFor='signup-email' name='Email' type='email' placeholder='name@email.com'></TextInput>
          <TextInput htmlFor='signup-password' name='Password' type='password' placeholder='password'></TextInput>
